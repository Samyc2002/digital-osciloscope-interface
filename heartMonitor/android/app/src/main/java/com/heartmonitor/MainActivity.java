...
public class MainActivity extends ReactActivity {
    ...
    /**
     * Required for react navigation to work.
     */
    @Override
     ...
     * util class {@link DefaultReactActivityDelegate} which allows you to
     * easily enable Fabric and Concurrent React (aka React 18) with two boolean
     * flags.
     */
    @Override
    protected ReactActivityDelegate createReactActivityDelegate() {
        return new DefaultReactActivityDelegate(
            ...
            DefaultNewArchitectureEntryPoint
                .getFabricEnabled(), // fabricEnabled
            // If you opted-in for the New Architecture, we enable Concurrent
            // React (i.e. React 18).
            DefaultNewArchitectureEntryPoint
